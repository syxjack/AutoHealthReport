...
//		{
			...
			ret.put("ryid", "124486");
			ret.put("xm", "xxx");
			ret.put("xh", "Y552000xx");
			ret.put("xydm", "10010900");
			ret.put("xy", "专业学位教育中心");
			ret.put("bj", "2020级MPAcc全日制2班");
			ret.put("xb", "男");
			ret.put("lxdh", "139xxxxxxx");
			ret.put("rysf", "研究生");
			ret.put("xq", "徐汇校区");
			ret.put("ss", "徐汇校区-学生xx");
			ret.put("mph", "xxx");
			ret.put("sfzh", "320102xxxxxxxxx");
			ret.put("jtzz", "南京市");
			ret.put("jjlxr", "xx");
			ret.put("jjlxrdh", "139xxxxx");
			ret.put("fdygh", "L0355");
			ret.put("fdy", "徐洁芸");
			ret.put("swjkzk","健康");
			ret.put("twsfzc", "是");
			...
			String[] cmds={"curl","-i","-k","-H","Content-type: application/json","-XPOST","-d",json.toString(),
			        ...
			        ,"JSESSIONID=yourownjsessionid; route=yourownroute; iPlanetDirectoryPro=yourownIPDP","-e","http://workflow.ecust.edu.cn/default/work/uust/zxxsmryb/mrybtb.jsp"};
